...
namespace Linker
{
    ...
    public static class JunctionPoint
    {
        ...
        /// Only works on NTFS.
        /// </remarks>
        /// <param name="linkDir">The junction point path</param>
        /// <param name="targetDir">The target directory</param>
        /// <param name="overwrite">If true overwrites an existing reparse point or empty directory</param>
        /// <exception cref="IOException">Thrown when the junction point could not be created or when
        /// an existing directory was found and <paramref name="overwrite" /> if false</exception>
        public static void Create(string linkDir, string targetDir, bool overwrite)
        {
            ...
            using (SafeFileHandle handle = OpenReparsePoint(linkDir, EFileAccess.GenericWrite))
            {
                ...
                try
                {
                    ...
                    bool result = DeviceIoControl(handle.DangerousGetHandle(), FsctlSetReparsePoint,
        ...
        public static void Delete(string junctionPoint)
        {
            ...
            using (SafeFileHandle handle = OpenReparsePoint(junctionPoint, EFileAccess.GenericWrite))
            {
                ...
                try
                {
                    ...
                    bool result = DeviceIoControl(handle.DangerousGetHandle(), FsctlDeleteReparsePoint,
                        // ReSharper disable once UnusedVariable
        ...
        private static string InternalGetTarget(SafeFileHandle handle)
        {
            ...
            try
            {
                bool result = DeviceIoControl(handle.DangerousGetHandle(), FsctlGetReparsePoint,
                    // ReSharper disable once UnusedVariable
